                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                                <form role="form" action="{{URL::to('luu-khoan-chi')}}" method="POST" enctype="multipart/form-data">
                                    @csrf()
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputOption">Loại chi</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="SoTienChi" id="exampleInputEmail1" placeholder="Nhập tiền thu..">
                                ...
                                <button type="submit" name="tao_chi" class="btn btn-info">Tạo</button>
                            </form>
                            </div>
